...
INSERT INTO `subjects` VALUES (1,'Бази Даних1','БД'),(2,'Архітектура комп\'ютера та комп\'ютерних мереж ','АККМ'),(3,'Введення до IT-бізнесу','ВдоIT'),(4,'Програмування мовою Python','ПрМР');
