...
INSERT INTO `schedule` VALUES (4,'2025-09-06',3,1,1,1,1),(5,'2025-10-01',2,1,1,1,1),(12,'2025-09-02',2,1,1,1,2),(14,'2025-09-05',3,1,1,1,3),(20,'2025-09-01',2,2,2,2,1),(21,'2025-09-02',3,3,4,2,3),(23,'2025-09-03',2,1,1,2,3),(24,'2025-09-02',2,4,3,2,2),(45,'2025-09-01',3,5,1,2,3),(46,'2025-09-01',4,5,1,2,3),(48,'2025-09-02',4,3,4,2,3),(52,'2025-09-03',3,1,1,1,1),(56,'2025-09-03',3,2,1,4,1),(57,'2025-09-04',3,4,3,1,2);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `prevent_room_double_booking` BEFORE INSERT ON `schedule` FOR EACH ROW BEGIN
    -- Якщо це НЕ дистанційна аудиторія, перевіряємо конфлікти:
    IF NEW.classroom_id != 2 THEN
        IF EXISTS (
